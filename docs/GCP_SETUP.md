...
- Access to the GCP project (e.g., `rle-ruritania-123edur1v1`)
...
gcloud iam workload-identity-pools create "github-pool" \
  --project="rle-ruritania-123edur1v1" \
  --location="global" \
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-123edur1v1" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-123edur1v1.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-123edur1v1 --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-123edur1v1.iam.gserviceaccount.com" \
  --project="rle-ruritania-123edur1v1" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-123edur1v1.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-123edur1v1.
